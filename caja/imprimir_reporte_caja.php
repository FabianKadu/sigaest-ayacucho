    ...
    ';
        ...
        while ($ingresos = mysqli_fetch_array($busc_ingr)) {
            ...
            <tr>
                ...
                <td align="left"><font size="6">' . floatval(decryptText($ingresos['monto'])) . '</font></td>
                <td align="rigth"><font size="6">' . floatval(decryptText($ingresos['subtotal'])) . '</font></td>
        ...
        ';
            $monto_total += floatval(decryptText($ingresos['subtotal']));
        }
    ...
    ';
        ...
        while ($egresos = mysqli_fetch_array($busc_ingr)) {
            ...
            <tr>
                ...
                <td align="rigth"><font size="7">' . floatval(decryptText($egresos['monto_total'])) . '</font></td>
        ...
        ';
            $monto_total += floatval(decryptText($egresos['monto_total']));
        }
