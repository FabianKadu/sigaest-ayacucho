                  ...
                  <div class="x_content">
                    ...
                    <form role="form" action="operaciones/actualizar_concepto_ingreso.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="monto" required="" value="<?php echo decryptText($conc_ingresos['monto']); ?>" style="text-transform:uppercase;" oninput="validateInputNum(this, 8)" onkeyup="javascript:this.value=this.value.toUpperCase();">
                          <br>
                        </div>
                      </div>
                      <div class="form-group">
