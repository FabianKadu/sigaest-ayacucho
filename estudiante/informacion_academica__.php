            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php while($modulo=mysqli_fetch_array($res_modulos)) {?>
                    <div class="x_content">
                      <h5><b>MÓDULO <?php echo $modulo['nro_modulo'].' : '.$modulo['descripcion']; ?></b></h5>
                      <div class="x_content">
                        <?php $res_semestres = buscarSemestreByIdModulo($conexion, $modulo['id']);
                        while($semestre=mysqli_fetch_array($res_semestres)){
                          $res_semestre = buscarSemestreById($conexion, $semestre['id_semestre']);
                        ...
                        <div class="x_content">
                          ...
                          <table class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              <?php
                              $res_unidad_didacticas = buscarUdByModSem($conexion, $modulo['id'], $semestre['id_semestre']);
                    ...
                    <!-- PARA PLANES DE ESTUDIO CON UNIDADES DIDACTICAS TRANSEVARSALES -->

                    <?php } 
                      $res_unidad_didacticas = buscarUdTransversalesByPrograma($conexion,$estudiante['id_programa_estudios']);
                      $cont_unidad = mysqli_num_rows($res_unidad_didacticas);

                    if($cont_unidad != 0){
                    ?>
                    <div class="x_content">
                      <h5><b>UNIDADES DIDÁCTICAS DE MÓDULOS FORMATIVOS TRANSVERSALES</b></h5>
                      <table class="table table-striped table-bordered" style="width:100%">
                        <thead>
                          <tr>
                            <th width="40%">UNIDAD DIDÁCTICA</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $unidad_didactica['descripcion'];?></td>
                            <td><?php
                            $res_semestre = buscarSemestreById($conexion,$unidad_didactica['id_semestre']);
                            $semestre=mysqli_fetch_array($res_semestre);
                            echo $semestre['descripcion'];?></td>
                            <td><?php echo $unidad_didactica['creditos'];?></td>
                            <td>
                            <?php 
                              $res_calificacion = getNotasImportadaByDniAndIdUd($conexion, $estudiante['dni'], $unidad_didactica['id']);
                    ...
                    <!-- PARA PLANES DE ESTUDIO CON UNIDADES DIDACTICAS ALTERNATIVA -->

                    <?php 
                      $res_unidad_didacticas = buscarUdAlternativasByPrograma($conexion,$estudiante['dni']);
                      $cont_unidad = mysqli_num_rows($res_unidad_didacticas);

                    if($cont_unidad != 0){
                    ?>
                    <div class="x_content">
                      <h5><b>UNIDADES DIDÁCTICAS ALTERNATIVAS CURSADOS POR EL ESTUDIANTE</b></h5>
                      <table class="table table-striped table-bordered" style="width:100%">
                        <thead>
                          <tr>
                            <th width="40%">UNIDAD DIDÁCTICA</th>
