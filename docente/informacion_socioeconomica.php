                                ...
                                <div class="x_panel">
                                    <div class="">
                                        <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                            <label class="control-label"> Condición de vida:
                                            </label>
                                            <div class="">
                                                <select class="form-control" name="condicion" id="" rows="5">
                                                    <option value="" disabled selected>Seleccione</option>
                                                    <option value="Pobre">Pobre</option>
                                                    <option value="Ponbre extremo">Pobre extremo</option>
                                                    <option value="No pobre">No opbre</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
