...
if (!verificar_sesion($conexion)) {
  ...
  <head>
    ...
    <title>Convalidaciones <?php include("../include/header_title.php"); ?></title>
    <!--icono en el titulo-->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="">
                    <h2 align="center">Convalidaciones</h2>
                    <a class="btn btn-success" href="./registrar_convalidaciones.php" data-toggle="tooltip"
                      data-original-title="Nuevo" data-placement="bottom"><i class="fa fa-plus-square"></i> Nuevo</a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="tabla-estudiantes" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                        $ejec_busc_conv = buscarConvalidaciones($conexion);
                        $cantidad = 1;
                        while ($res_busc_conv = mysqli_fetch_array($ejec_busc_conv)) {
                          ?>
                          <tr>
                            <td><?php echo $res_busc_conv['id']; ?></td>

                            <?php
                            $ejec_busc_est = buscarEstudianteById($conexion, $res_busc_conv['id_estudiante']);
                            ...
                            <?php
                            $id_sem = $res_busc_conv['id_semestre'];
                            ...
                            <td align="center">
                              <a class="btn btn-warning"
                                href="detalles_convalidacion.php?id=<?php echo $res_busc_conv['id_estudiante']; ?>"
                                data-toggle="tooltip" data-original-title="Ver detalles" data-placement="bottom"><i
                                  class="fa fa-eye"></i></a>
                            </td>
                          </tr>
                          <?php
