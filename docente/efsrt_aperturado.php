            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="apertura_efsrt.php" class="btn btn-success"><i class="fa fa-plus-square"></i> Nuevo</a>
                    <br />
                    <table id="tabla-efsrt" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                        $ejec_busc_est = buscarEfsrtAperturados($conexion);
                        $cantidad = 1;
                        ...
                        ?>
                          <tr>
                            ...
                            <td>                               
                                <a href="cierre_efsrt.php?id=<?php echo $efsrt['id'] ?>" class="btn btn-primary">Cerrar efsrt</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
