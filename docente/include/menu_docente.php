        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-pencil-square-o"></i> Unidades Didácticas <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              ...
              <li class="sub_menu"><a href="solicitudes_unidad_didactica.php">Solicitudes</a></li>
            </ul>
          </li>
  ...
  <div class="nav_menu">
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <?php if ($res_b_u_sesion['cargo_inmutable'] == 7) { ?>
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <?php
              $res_cargo = buscarCargoById($conexion, $res_b_u_sesion['id_cargo']);
            ...
            <ul class="dropdown-menu  pull-right">
              ...
              <?php }
              if ($res_b_u_sesion['id_cargo'] == 5) {
                $res_cargo = buscarCargoById($conexion, 7);
                $cargo = mysqli_fetch_array($res_cargo); ?>
                <li><a href="operaciones/actualizar_cargo.php?cargo=7"><?php echo $cargo['descripcion']; ?></a></li>
              <?php } ?>
            </ul>
          </li> <?php } ?>
      </ul>
