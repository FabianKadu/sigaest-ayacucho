...
if (!verificar_sesion($conexion)) {
  ...
  <head>
    ...
    <title>Reportes nomina <?php echo $r_b_sem['descripcion']; ?><?php include("../include/header_title.php"); ?></title>
    <!--icono en el titulo-->
  ...
  <body>
    <h3 align="center"><b>REPORTE NOMINA - <?php echo "SEMESTRE " . $r_b_sem['descripcion']; ?></b>
    </h3>
