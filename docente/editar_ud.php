                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <form role="form" action="operaciones/actualizar_unidad_didactiva.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Codigo Correlativo : </label>
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" name="codigo_correlativo" required="" value="<?php echo $res_busc_ud['codigo_correlativo']; ?>" maxlength="2">
                            <br>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Codigos unidades didacticas predecesoras : </label>
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" name="codigos_ud_predecesora" required="" value="<?php echo $res_busc_ud['codigos_ud_predecesora']; ?>" maxlength="2">
                            <br>
                          </div>
                        </div>
