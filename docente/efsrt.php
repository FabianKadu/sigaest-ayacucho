          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="">
                    <h2 align="center">EFSRT</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <table id="tabla-efsrt" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>N°</th>
                          <th>DNI</th>
                      ...
                      <tbody>
                        <?php
                        $ejec_busc_est = buscarEfsrtAprobados($conexion);
                        $cantidad = 1;
                        while ($efsrt = mysqli_fetch_array($ejec_busc_est)) {
                        ?>
                          <tr>
                            <td><?php echo $cantidad++; ?></td>
                            <td><?php
                                $id_estudiante = $efsrt['id_estudiante'];
                                $busc_est = buscarEstudianteById($conexion, $id_estudiante);
                                $res_busc_est = mysqli_fetch_array($busc_est);
                                echo $res_busc_est['dni'];
                                ?>
                                
                            </td>
                            <td><?php
                                echo $res_busc_est['apellidos_nombres'];
                                ?>
                            ...
                            <td>                               
                                <a href="detalle_efsrt.php?id=<?php echo $res_busc_est['id'] ?>" class="btn btn-primary">Detalles</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
